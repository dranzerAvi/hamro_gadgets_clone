 ...
 void verify(number)async{
   ...
   await FirebaseAuth.instance.verifyPhoneNumber(
     ...
     if(_verificationId!=null){
       ...
       Navigator.push(context,MaterialPageRoute(builder:(context)=>OtpScreen(_verificationId,phnno)));
     }
                  ...
                  child:Column(
                    children: [
                      Padding(
                        ...
                        child: Text('Welcome to Hamro Gadgets',style:TextStyle(color:primarycolor,fontWeight: FontWeight.bold,fontSize: height*0.025)),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(20.0),
                        child: TextFormField(
